...
##########################################################################
                     API="result" 
                     google_sheet="https://docs.google.com/spreadsheets/d/1HwM6j2mFSONay51Uj4LTtYmi1ucVkwzK0nTEocmkKkQ/edit?gid=1610289956#gid=1610289956" 
                     id="99"                 #เปลี่ยน id ทุกครั้งที่ยิง
                     user="3";              #จำนวนผู้ใช้งาน
                     duration="60";          #วินาที
